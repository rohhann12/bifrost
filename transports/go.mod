...
require (
	...
	github.com/maximhq/bifrost/core v1.1.31
	github.com/maximhq/bifrost/framework v1.0.11
	github.com/maximhq/bifrost/plugins/governance v1.2.5
	github.com/maximhq/bifrost/plugins/logging v1.2.5
	github.com/maximhq/bifrost/plugins/maxim v1.2.3
	github.com/maximhq/bifrost/plugins/semanticcache v1.2.6
	github.com/maximhq/bifrost/plugins/telemetry v1.2.4
