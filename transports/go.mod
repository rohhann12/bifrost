...
require (
	...
	github.com/maximhq/bifrost/plugins/governance v1.2.1
	github.com/maximhq/bifrost/plugins/logging v1.2.1
	github.com/maximhq/bifrost/plugins/maxim v1.2.1
	github.com/maximhq/bifrost/plugins/semanticcache v1.2.3
