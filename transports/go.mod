...
require (
	...
	github.com/maximhq/bifrost/core v1.1.27
	github.com/maximhq/bifrost/framework v1.0.5
	github.com/maximhq/bifrost/plugins/governance v1.2.0
	github.com/maximhq/bifrost/plugins/logging v1.2.0
	github.com/maximhq/bifrost/plugins/maxim v1.2.1
	github.com/maximhq/bifrost/plugins/semanticcache v1.2.1
